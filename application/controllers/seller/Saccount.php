...
//        if($isLogined&&$this->router->method == 'logout'){
//            return;
//        }
...
//              $this->load->view("sellerv/Sloginv",$data);
    }
    //注册
    function register(){
                ...
                if($originalImg){
                    ...
                    if($newImg){
                        ...
                        if(imagejpeg($newImg,$abspath,$jpeg_quality)){
                            $msg= '裁剪成功';
//                            $data['headimg']=  str_replace('../',  base_url(), $abspath);
    ...
    public function setProfile(){
        ...
        if($isModify==1){
//                $data['sname']=  $this->input->post('username',TRUE);
